# -*- coding: utf-8 -*-
"""
Created on Wed Sep 19 18:47:23 2018
...
cascade_path= path + 'Haarcascades/haarcascade_frontalface_default.xml'
...
def face_swap(img,name):
    ...
    image = cv2.imread(path + 'output.jpg')
...
filter_image =  path + "images/Trilochan.png" ### Put your image here!
dlibOn = False
...
while True:   
    ...
    #cv2.imshow('Image',image_processor(frame))
